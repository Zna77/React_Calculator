    ...
    <>
      <div className="w-80 sm:w-96 md:w-96 mx-auto mt-14 text-center p-5 bg-opacity-30 backdrop-blur-md border border-slate-200/20 rounded-xl shadow-md">
        ...
        <div className="grid grid-cols-4 grid-rows-5 gap-1.5 p-2.5 rounded-2xl">
          <button
            className="bg-slate-50/[0.1] text-center h-16 text-white border-none rounded-2xl p-2.5 font-share-tech-mono text-2xl cursor-pointer transition-all duration 300ms hover:bg-slate-50/[0.2] hover:scale-105 active:bg-slate-50/[0.3] active:scale-95"
            data-key="AC"
            onClick={handleClear}
          >
            AC
          ...
          <button
            className="col-[1_/_3] bg-slate-50/[0.1] text-center h-16 text-white border-none rounded-2xl p-2.5 font-share-tech-mono text-2xl cursor-pointer transition-all duration 300ms hover:bg-slate-50/[0.2] hover:scale-105 active:bg-slate-50/[0.3] active:scale-95"
            data-key="0"
          ...
          <button
            className="col-[4_/_5] row-[6_/_4] bg-slate-50/[0.1] h-auto text-center text-white border-none rounded-2xl p-2.5 font-share-tech-mono text-2xl cursor-pointer transition-all duration 300ms hover:bg-slate-50/[0.2] hover:scale-105 active:bg-slate-50/[0.3] active:scale-95"
            data-key="="
